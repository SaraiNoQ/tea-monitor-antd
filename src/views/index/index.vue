<template>
  <div class="content">
    <a-config-provider :locale="zhCN">
      ...
      <List v-if="routerPath.path === '/home/index'" />
      <Detail v-else-if="routerPath.path === '/home/index/details'" />
    </a-config-provider>
  </div>
</template>
...
const routerPath = computed(() => routes.currentRoute.value);
watch(
  () => routerPath.value,
  () => {
    // console.log("route", routerPath.value.matched);
  }
);
</script>
